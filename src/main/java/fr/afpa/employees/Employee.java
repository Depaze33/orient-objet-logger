...
class Employee {
	...
	public void setLastName(String lastName) throws Exception {
		...
		if (isLastName == true) {
			...
			IllegalArgumentException e = new IllegalArgumentException("Le nom saisie n'est pas correct");
			logger.error(e.getMessage(),e);
			throw e;
	...
	public void setFirstName(String firstName) throws Exception {
		...
		if (isFirstName == true) {
			...
			IllegalArgumentException e = new IllegalArgumentException("Le prenom saisie n'est pas correct");
			logger.error(e.getMessage(),e);
			throw e;
		}
	...
	public void setBirthDay(String birthDay) throws Exception {
		...
		if (isDate == true) {
			...
			IllegalArgumentException e = new IllegalArgumentException("La date de naissance n'est pas correctement formate");
			logger.error(e.getMessage(),e);
			throw e;
		}
